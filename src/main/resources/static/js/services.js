...
function clearInputsForms(inputs) {
...
function openModalEdit(id) {
    fetch(`/todos/${id}`, {
        ...
        const form = document.getElementById("form_modal_editTodo");
...
function openModalAdd() {
    const form = document.getElementById("form_modal_addTodo");
...
function reloadPage({ state_reload }) {
    if (state_reload) {
...
function addTodo(event) {
    ...
    event.preventDefault();
    const form = document.getElementById("form_modal_addTodo");
    const dataForm = formFields(form, inputNameAdd);
...
function confirmDeleteTodo(id, state) {
